...
type Props = { action: ItineraryAction; index: number; targetName?: string; isPlanAdded: (item: ItineraryItem) => boolean; onAddItineraries: (items: ItineraryItem[]) => void };
...
export function ItineraryActionButton({ action, index, targetName, isPlanAdded, onAddItineraries }: Props) {
