...
export type RichPlace = { name: string; category?: string; area?: string; description?: string; rating?: string | number; reviewCount?: string; price?: string; openingHours?: string; recommendedDuration?: string; imageUrl?: string; images?: TravelImage[]; recommendationReasons?: string[]; itineraryItem?: ItineraryItem };
export type RichRestaurant = { name: string; cuisine?: string; area?: string; description?: string; rating?: string | number; reviewCount?: string; averagePrice?: string; openingHours?: string; recommendedDishes?: string[]; imageUrl?: string; images?: TravelImage[]; recommendationReasons?: string[]; itineraryItem?: ItineraryItem };
